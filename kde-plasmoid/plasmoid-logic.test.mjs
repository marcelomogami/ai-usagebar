...
import {
    ...
    detailRows, displayedEntries, entryFor, errorMessage, EXIT_KILLED, EXIT_TIMED_OUT,
    formatDuration,
...
assert.equal(codexCard.accent, 'mid');
assert.deepEqual(codexCard.windows.map(w => w.window), ['5h', '7d']);
